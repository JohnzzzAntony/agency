...
// Use portable fingerprints: Git checkout line endings differ on Windows and Linux.
const templates = new Map(files.map(file => [file, fs.readFileSync(path.join(ROOT,file),'utf8').replace(/\r\n?/g,'\n')]));
